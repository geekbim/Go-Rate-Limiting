...
func main() {
	http.Handle("/test1", rateLimiter(endpointHandler))
	http.Handle("/test2", perClientRateLimiter(endpointHandler))
	...
	http.Handle("/test3", tollbooth.LimitFuncHandler(tlbthLimiter, endpointHandler))
